...
for i = 1%:3
    ...
    view(v(i,1),v(i,2));
    plotSpot(0,0,1)
    matlab2tikz(['hoverpres2' num2str(i) '.tikz'], 'height', '\figureheight', 'width', '\figurewidth','extraAxisOptions','ticklabel shift={0.1cm}');
end

figure(2); clf; hold on;
plot(time, [sqrt(x.^2 + y.^2 + z.^2) sqrt(x.^2 + y.^2) z yaw])
legend('xyz','xy','z','yaw')
