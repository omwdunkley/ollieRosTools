...
%     subplottight(2,2,4); cla; hold on;
    ...
    subplot(6,1,5); cla; hold on;
    plot(bag.baro.time, [bag.baro.aslRaw bag.baro.aslLong bag.baro.asl]);
    legend('aslRaw','aslLong','asl');
    ylim([-2 2]);
    
    
    subplot(6,1,6); cla; hold on;
    plot(bag.baro.time, [bag.baro.aslRaw bag.baro.aslLong bag.baro.asl]);
    legend('aslRaw','aslLong','asl');
    ylim([mean(bag.baro.aslLong)-3 mean(bag.baro.aslLong)+3]);
