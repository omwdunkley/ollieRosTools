...
figure(2); clf; hold on; grid on; title('Angle Approximation [degrees]'); xlabel('Angle [degrees]'), ylabel('error / thresh');
plot(e(:,1),'r');
plot(e(:,2),'g');
plot(e(:,3),'b');
plot(e(:,4),'k');
...
legend('||(AxB)||', '1 - A.B', 'atan2(\|(AxB)\|, A.B)', '||(A-B)||', 'SUM((A-B)^2)')

matlab2tikz('bvCompare.tikz', 'height', '\figureheight', 'width', '\figurewidth');
